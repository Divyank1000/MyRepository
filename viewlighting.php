...
<head>
    ...
    <body>
        <div class="dark-version">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-4 col-xs-12">
                                <h2 class="heading-color theme-title">Our Products</h2>
                            </div>
			...
			<!--//====================product display from backend start==================================//-->
               ...
               <div class="container">
                    <div class="row">
						...
						<?php while ($row=mysqli_fetch_assoc($d)) { ?>
						 ...
						 <div class="col-md-12 col-sm-6 col-xs-12 mix category-4" >
                       <h1><label style="color:yellow">Product name:</label></h1><h3> <?php echo $row['title']; ?></h3>
						<h1><label style="color:yellow">Product type:</label></h1><h3><?php echo $row['type']; ?><h3>
				...
				<!--//====================product display from backend end==================================//-->
            </section>
