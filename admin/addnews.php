...
<html>
<head>
<title>Patronik Lighting|Add News</title>
...
<div class="input-group">
                ...
                <input type="text" name="news_header" required="" pattern="[a-zA-Z ]*">
            </div>
            <div class="input-group">
                 <label>Image</label>  
             ...
             <!--<img src="image/<?php /*echo $image; */?>" name="image" height="100px" width="100px" alt="<?php /*echo $image; */?>">-->   
                ...
                <textarea rows ="5" cols="50" name="description" required="" pattern="[a-zA-Z ]*"></textarea>
                </div>
                <div class="input-group">
                 <label>Date</label>
