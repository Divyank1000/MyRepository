...
$title="";
 ...
 $g_id=$_GET['id2'];
$sql1="select * from gallery where g_id='$g_id'";
...
$g_id=$_POST['g_id'];
	...
	/*$sql = "update gallery SET title='$title',image='$image' where g_id='$g_id'"; 
	...
	if(!empty($_FILES['image']['name']))
        {
            ...
            $query="UPDATE gallery SET title='$title',image='$image' WHERE g_id='$g_id'"; 
		$res1=mysqli_query($conn,$query);
		}  
 else {
         $query="UPDATE gallery SET title='$title' WHERE g_id='$g_id'";
        $res1=mysqli_query($conn,$query);
 }
	if($res1){
		echo "<script> alert('updated successfully')
...
<html>
<head>
<title>Patronik Lighting|Edit Gallery</title>
...
<div class="input-group">
				 ...
				 <input type="hidden" name="g_id" value="<?php echo $abc['g_id'];?>"/>
