...
<html>
<head>
<title>Patronik Lighting|Projects</title>
...
<h2><a class="button button1" href="addproject.php">Add</a></h2></div>
            ...
            <thead>
                <tr>
				 <th>Image</th>
                   ...
                   <!-- <th><a class="button button1" href="addproject.php">Add</a></th>-->
                </tr>
            </thead>
            <tbody>
                <?php
...
<td><a class="button button2" href="editproject.php?id2=<?php echo $row['proj_id']; ?> ">Edit</a></td>
<td><a class="button button3" href="deleteproject.php?id3=<?php echo $row['proj_id']; ?> ">Delete</a></td>
                    </tr>
<?php } ?>
            </tbody>
        </table>
