...
<html>
<head>
<title>Patronik Lighting|Banners</title>
...
<h2><a class="button button1" href="addbanners.php">Add</a></h2></div>
...
<td><a class="button button2" href="editbanners.php?id2=<?php echo $row['b_id']; ?> ">Edit</a></td>
<td><a class="button button3" href="deletebanners.php?id3=<?php echo $row['b_id']; ?> ">Delete</a></td>
                    </tr>
<?php } ?>
            </tbody>
        </table>
