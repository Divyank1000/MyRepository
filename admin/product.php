...
<html>
<head>
<title>Patronik Lighting|Products</title>
...
<h2><a class="button button1" href="addproduct.php">Add</a></h2></div>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($cat)) {
					...
					<td><?php echo $row['title']; ?></td>
                        ...
                        <td><a class="button button4" href="pdf/<?php echo $row['pdf']; ?>" target="_blank">View PDF</a></td>
                           
                          

<td><a class="button button2" href="editproduct.php?id2=<?php echo $row['pid']; ?> ">Edit</a></td>
<td><a class="button button3" href="deleteproduct.php?id3=<?php echo $row['pid']; ?> ">Delete</a></td>
                    </tr>
<?php } ?>
            </tbody>
        </table>
