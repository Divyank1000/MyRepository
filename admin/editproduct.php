...
if(!empty($_FILES['image']['name']))
        {
            ...
            $query="UPDATE product SET title='$title',type='$type',image='$image',description='$description',pdf='$pdf' WHERE pid='$pid'"; 
		$res1=mysqli_query($conn,$query);
		}  
 else {
         $query="UPDATE product SET title='$title',type='$type',description='$description',pdf='$pdf' WHERE pid='$pid'";
        $res1=mysqli_query($conn,$query);
 }	
	if($res1){
...
<html>
<head>
<title>Patronik Lighting|Edit Product</title>
...
<div class="input-group">
				 ...
				 <input type="hidden" name="pid" value="<?php echo $abc['pid'];?>"/>
                <input type="text" name="title" value="<?php echo $abc['title'];?>"/>
            </div>
			<div class="input-group">
                 <label>Type</label>
                <input type="text" name="type" value="<?php echo $abc['type'];?>"/>
	...
	<option value="automation">Automation</option>
        <option value="lighting">Lighting</option>
            ...
            <div class="input-group">
             ...
             <img src="image/<?php echo $abc['image']; ?>" height="100px" width="100px" alt="image"/>   
           
       
                <div class="input-group">
                 <label>Description</label>
                <input type="text" name="description" width="500px" value="<?php echo $abc['description'];?>"/>
                </div>
				
                <div class="input-group">
                 <label>PDF</label>
                <input type="file" name="pdf" id="pdf" onchange="validatePdf()" value="<?php echo $abc['pdf'];?>"/> 
                </div>
				
<!--<iframe src="pdf/<?php /*echo $abc['pdf'];*/ ?>" height="300px" width="200px" alt="image"/></iframe> <br><br/> -->
<button class="button button4" type="submit" value="button" name="update">Update</button>
