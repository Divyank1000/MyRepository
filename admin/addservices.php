...
$image = generateRandomString();
    ...
    $sql = "insert into services(s_name,s_desc,image) values('$s_name','$s_desc','$image')";  
...
<html>
<head>
<title>Patronik Lighting|Add Services</title>
	...
	<div class="main-content">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <input type="text" name="s_name" required="" pattern="[a-zA-Z ]*"/>
            </div>
            <div class="input-group">
                 <label>Service description</label>  
               <textarea rows ="5" cols="50" name="s_desc" required="" pattern="[a-zA-Z0-9 ]*"/></textarea>
            </div>
