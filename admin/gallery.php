...
<html>
<head>
<title>Patronik Lighting|Gallery</title>
...
<h2><a class="button button1" href="addgallery.php">Add</a></h2></div>
            ...
            <thead>
                <tr>
                    ...
                    <!--<th><a class="button button1" href="addbanners.php">Add</a></th>-->
                </tr>
            </thead>
            <tbody>
                <?php
...
<td><a class="button button2" href="editgallery.php?id2=<?php echo $row['g_id']; ?> ">Edit</a></td>
<td><a class="button button3" href="deletegallery.php?id3=<?php echo $row['g_id']; ?> ">Delete</a></td>
                    </tr>
<?php } ?>
            </tbody>
        </table>
