...
$s_id=$_GET['id2'];
$sql1="select * from services where s_id='$s_id'";
...
$s_id=$_POST['s_id'];
	...
	/*$sql = "update services SET s_name='$s_name',s_desc='$s_desc',image='$image' where s_id='$s_id'"; 
	...
	if(!empty($_FILES['image']['name']))
        {
            ...
            $query="UPDATE services SET s_name='$s_name',s_desc='$s_desc',image='$image' WHERE s_id='$s_id'"; 
		$res1=mysqli_query($conn,$query);
		}  
 else {
         $query="UPDATE services SET s_name='$s_name',s_desc='$s_desc' WHERE s_id='$s_id'";
        $res1=mysqli_query($conn,$query);
 }
	if($res1){
		echo "<script> alert('updated successfully')
...
<div class="input-group">
                ...
                <input type="text" name="s_name" value="<?php echo $abc['s_name'];?>"/>
            </div>
			
			<div class="input-group">
                 <label>Service description</label>
                <input type="text" name="s_desc" value="<?php echo $abc['s_desc'];?>"/>
            </div>
