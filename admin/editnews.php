...
$nid=$_GET['id2'];
$sql1="select * from news where n_id='$nid'";
...
$n_id=$_POST['n_id'];
	...
	$date=$_POST['date'];
	/*$sql = "update news SET news_header='$news_header',image='$image',description='$description',date='$date' where n_id='$n_id'"; 
	...
	if(!empty($_FILES['image']['name']))
        {
            ...
            $query="UPDATE news SET news_header='$news_header',image='$image',description='$description',date='$date' WHERE n_id='$nid'"; 
		$res1=mysqli_query($conn,$query);
		}  
 else {
         $query="UPDATE news SET news_header='$news_header',description='$description',date='$date' WHERE n_id='$nid'";
        $res1=mysqli_query($conn,$query);
 }
	if($res1){
		echo "<script> alert('updated successfully')
...
<html>
<head>
<title>Patronik Lighting|Edit News</title>
...
<div class="input-group">
				 ...
				 <input type="hidden" name="n_id" value="<?php echo $abc['n_id'];?>"/>
                <input type="text" name="news_header" value="<?php echo $abc['news_header'];?>"/>
            </div>
            ...
            <div class="input-group">
             ...
             <img src="image/<?php echo $abc['image']; ?>" height="100px" width="100px" alt="image"/>   
                ...
                <div class="input-group">
                 <label>Date</label>
                <input type="date" name="date" value="<?php echo $abc['date'];?>"/>
                </div>
