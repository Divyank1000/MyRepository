...
$b_id=$_GET['id2'];
$sql1="select * from banners where b_id='$b_id'";
	...
	if(!empty($_FILES['image']['name']))
        {
            ...
            $query="UPDATE banners SET main_title='$main_title',sub_title='$sub_title',image='$image' WHERE b_id='$b_id'"; 
		$res1=mysqli_query($conn,$query);
		}  
 else {
         $query="UPDATE banners SET main_title='$main_title',sub_title='$sub_title' WHERE b_id='$b_id'";
        $res1=mysqli_query($conn,$query);
 }
	if($res1){
...
<html>
<head>
<title>Patronik Lighting|Edit Banners</title>
...
<div class="input-group">
				 ...
				 <input type="hidden" name="b_id" value="<?php echo $abc['b_id'];?>"/>
                <input type="text" name="main_title" value="<?php echo $abc['main_title'];?>"/>
            </div>
			
			<div class="input-group">
                 <label>Sub Title</label>
                <input type="text" name="sub_title" value="<?php echo $abc['sub_title'];?>"/>
            </div>
