...
$image = generateRandomString();
    ...
    $sql = "insert into banners(main_title,sub_title,image) values('$main_title','$sub_title','$image')";  
...
<html>
<head>
<title>Patronik Lighting|Add Banners</title>
	...
	<div class="main-content">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <input type="text" name="main_title"  required="" pattern="[a-zA-Z ]*"/>
            </div>
            <div class="input-group">
                 <label>Sub Title</label>  
                <input type="text" name="sub_title"  required="" pattern="[a-zA-Z ]*"/>
            </div>
            <div class="input-group">
                 <label>Image</label>  
