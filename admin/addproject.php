...
$image = generateRandomString();
	...
	$sql = "insert into project(image,name,architecture,product) values('$image','$name','$architecture','$product')";  
...
<html>
<head>
<title>Patronik Lighting|Add Projects</title>
	...
	<div class="main-content">
		...
		<div class="input-group">
			...
			<div class="input-group">
                ...
                <input type="text" name="architecture" required="" pattern="[a-zA-Z ]*">
                </div>
                <div class="input-group">
                 <label>Product</label>
                <input type="text" name="product" required="" pattern="[a-zA-Z0-9 ]*">
                </div>
"
