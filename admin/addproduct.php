...
$image = generateRandomString();
	...
	//pdf random string generation start
$pdf = generateRandomString();
	...
	"pdf/" .$pdf); 
	//pdf random string generation end
  
	$sql = "insert into product(title,type,image,description,pdf) values('$title','$type','$image','$description','$pdf')";  
...
<html>
<head>
<title>Patronik Lighting|Add Product</title>
        ...
        <option value="lighting">Lighting</option>
            ...
            <div class="input-group">
             ...
             <!--<img src="image/<?php /*echo $image; */?>" name="image" height="100px" width="100px" alt="<?php /*echo $image; */?>">-->   
                ...
                <textarea rows ="5" cols="50" name="description" required="" pattern="[a-zA-Z0-9 ]*"></textarea>
                </div>
                <div class="input-group">
                 <label>PDF</label>
                <input type="file" name="pdf" id="pdf" onchange="validatePdf()" required="" >
                </div>


<input type="submit" class="btn" value="Submit" name="add"/>
</form>
<!-- Classie -->
