...
<html>
<head>
<title>Patronik Lighting|Services</title>
...
<h2><a class="button button1" href="addservices.php">Add</a></h2></div>
            ...
            <thead>
                <tr>
                    ...
                    <!--<th><a class="button button1" href="addservices.php">Add</a></th>-->
                </tr>
            </thead>
            <tbody>
                <?php
...
<td><a class="button button2" href="editservices.php?id2=<?php echo $row['s_id']; ?> ">Edit</a></td>
<td><a class="button button3" href="deleteservices.php?id3=<?php echo $row['s_id']; ?> ">Delete</a></td>
                    </tr>
<?php } ?>
            </tbody>
        </table>
