...
$sql6="select * from news where n_id='$n_id'";
$j=mysqli_query($conn,$sql6);
...
<head>
    ...
    <body>
        <div class="dark-version">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-4 col-xs-12">
                                <h2 class="heading-color theme-title">Our News</h2>
                            </div>
			...
			<!--//====================news display from backend start==================================//-->
			
               <div class="container">
                    <div class="row">
                        <div id="mixi-box">
						<?php while ($row=mysqli_fetch_assoc($j)) { ?>
						 ...
						 <div class="col-md-12 col-sm-6 col-xs-12 mix category-4" >
                       <h1><label style="color:yellow">News Header:</label></h1></style><h3><?php echo $row['news_header']; ?></h3>
						<h1><label style="color:yellow">Description:<label></h1><h3> <?php echo $row['description']; ?><h3>
						<h1><label style="color:yellow">Date:<label></h1><h3> <?php echo $row['date']; ?></h3>
                            </div>
