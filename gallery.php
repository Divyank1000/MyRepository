        ...
        <div class="dark-version">
            ...
            <div class="breadcrumb-section-box">
                <div class="special-style special-style-full special-style-semidark col-md-12 col-md-offset-0 pull-right">
                    <div class="bg-image" style="background-image:url('admin/image/yu.jpg');"></div>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 pad-top250 pad-bottom0 heading-box">
                            <h1 class="heading-color box-z">Gallery</h1>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="itg-box-style-1">
                                    <figure class="hover-section">
									   ...
									   <figcaption class="icon-box">
                                        <ul class="icon-hover">
                                            <li><a href="admin/image/<?php echo $row['image']?>" class="fancybox" data-fancybox-group="group"><i class="fa fa-eye" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </figcaption>
									   </figure>
                               <div class="box-caption">
								
                                        <h3 class="pad-top15"><?php echo $row['title']; ?></h3>
                                    </div>
									</div>
                        </div>
					<?php } ?>
