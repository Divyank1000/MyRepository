        ...
        <div class="dark-version">
            ...
            <div class="breadcrumb-section-box">
                <div class="special-style special-style-full special-style-semidark col-md-12 col-md-offset-0 pull-right">
                    <div class="bg-image" style="background-image:url('assets/img/Projects/folder/g.jpg');"></div>
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 pad-top250 pad-bottom0 heading-box">
                            <h1 class="heading-color box-z">Automation</h1>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
			...
			<?php include("db.php");
				...
				$sql = "select * from product where type='automation'";
                                ...
                                <div class="itg-box-style-1">
                                    ...
                                    <img src="admin/image/<?php echo $row['image'];?>" alt="" width="500px" height="300px">
									   ...
									   <div class="box-caption">
                                        ...
                                        <h3 class="pad-top15"><a href="automation.php" style="color:yellow;"><?php echo $row['title']; ?></a></h3>
                                    </div>
							
							<center><a href="viewautomation.php?id2=<?php echo $row['pid']; ?> " class="btn btn-primary" role="button">View</a></center>					
                                    <div class="post-sec">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="row">
                                             
											<br><center><a href="admin/pdf/<?php echo $row['pdf'];?>" target="_blank" class="btn btn-success" role="button">Specifications</a></br><br>
											 </div>
                                        </div>
                                    </div>
                                </div>
