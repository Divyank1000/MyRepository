        ...
        <div class="dark-version">
            ...
            <div class="breadcrumb-section-box">
                <div class="special-style special-style-full special-style-semidark col-md-12 col-md-offset-0 pull-right">
                    ...
                    <div class="bg-image" style="background-image:url(admin/image/jesus.jpg);"></div>
                </div>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 pad-top250 pad-bottom0 heading-box">
                            ...
                            <h1 class="heading-color box-z">Lightning</h1>
                            <div class="clear"></div>
			...
			<?php include("db.php");
				...
				$sql = "select * from product where type='lighting'";
                                ...
                                <div class="itg-box-style-1">
                                    <figure class="hover-section">
                                       <img src="admin/image/<?php echo $row['image'];?>" alt="" width="500px" height="300px">
                                        ...
                                        <h3 class="pad-top15"><a href="lighting.php" style="color:yellow;"><?php echo $row['title']; ?></a></h3>
                                    </div>
									<center><a href="viewlighting.php?id3=<?php echo $row['pid']; ?> " class="btn btn-primary" role="button">View</a></center>			
                                    <div class="post-sec">
